                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left text-sm whitespace-nowrap">
                        <thead className="bg-gray-100 text-gray-600 uppercase text-xs font-semibold">
                            <tr>
                                <th className="px-3 py-2 border-b">PIN No</th>
                                <th className="px-3 py-2 border-b">Photo</th>
                                <th className="px-3 py-2 border-b">Student Name</th>
                                <th className="px-3 py-2 border-b">Branch</th>
                                <th className="px-3 py-2 border-b">Year/Sem</th>
                            ...
                            {loading ? (
                                ...
                                students.map(student => (
                                    <tr key={student.id} className="border-b border-gray-100 last:border-0 hover:bg-primary-50/50 transition-colors">
                                        <td className="px-3 py-2 font-semibold text-primary-700">{student.rollNo || '-'}</td>
                                        ...
                                        <td className="px-3 py-2 text-gray-600">{student.branch || '-'}</td>
                                        <td className="px-3 py-2 text-gray-600">{student.year || '-'} / {student.sem || '-'}</td>
                                        <td className="px-3 py-2">
